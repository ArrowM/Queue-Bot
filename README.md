...
| Kick | `!k {channel name} @{user 1} @{user 2} ...` | Kicks one or more people. If a queue name is given, it will kick from a single queue. Otherwise, it will kick people from every queue. |
