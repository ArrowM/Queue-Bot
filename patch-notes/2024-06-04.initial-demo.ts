...
export const embeds = [
	new EmbedBuilder()
		.setTitle(`Announcing the demo of QueueBot 2! 🎉`,)
		.setColor("#f3be35")
		.setDescription(`I'm excited to announce the demo of Queue Bot 2! There is an invite link at the bottom of this message.`)
		.addFields(
			{
				name: `🐣 What's new?`,
